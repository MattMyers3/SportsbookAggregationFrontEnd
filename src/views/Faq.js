            ...
            <div className="content">
                <Card>
                    ...
                    <div className="mt-3">
                        ...
                        {this.renderFAQ("I don’t have an account with all of the sportsbooks, or I don’t want to show certain sportsbooks.  How do I hide them?","At the top of the page, you can deselect a sportsbook.  The deselected books will no longer be displayed.  Your selections will be maintained as you switch between sports.",4)}
                        {this.renderFAQ("How do I report a bug or submit feedback?","Please email support@oddslibrary.com  to report a bug or submit feedback.  Please let us know how we are doing or if something is not working how you would like it to!",5)}
                        </Accordion>
                    </div>
                    </CardBody>
                </Card>
