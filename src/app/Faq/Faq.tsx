          ...
          <CardBody>
            <div className="mt-3">
              ...
              <Typography>
                ...
                sportsbooks in Pennsylvania. If you do not want to display
                certain sportsbooks, deselect them by unchecking the box next to
                their name. Lines are pulled every 10 minutes (on the 10-minute
                marks) and the last refresh time is shown at the top of the
                page. You must manually refresh the page to display updated
                odds.
              </Typography>
